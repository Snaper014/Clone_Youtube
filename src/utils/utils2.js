...
, [refWidth, loading, HasCaroussel])
  ...
  return(
    ...
    {loading === true ? <div style={{width: '100%'}}>chargement...</div> : 
            ...
            <div key={index} className="SearchContainer">
                  ...
                  <div style={{position: 'relative', cursor: 'pointer'}}>
                    ...
                    <div className={`${element?.lengthText === "EN DIRECT" ? 'IndicatorLive' : 'IndicatorView'}`}>
                      ...
                      {element?.lengthText === "EN DIRECT" ? 'EN DIRECT' : element?.lengthText}
                      </p>
                    </div>
                  </div>
                  </Link>
                  <div style={{marginLeft: '2%'}}>
                    <p style={{fontSize: '20px', marginBottom: '1%'}}>{element?.title}</p>
                      ...
                      <Link to={`/Channel/${Data?.data?.meta?.channelId}`}
                        key={index}
                        style={{textDecoration: 'none', color: 'black'}} 
                      >            
                    ...
                    <img style={{ 
                            ...
                            borderRadius: '50%', 
                            marginRight: '1%',
                            }} src={Data?.data?.meta?.avatar[1]?.url} alt={element?.title}>
                            </img>
          ...
          <div style={{
            ...
            alignItems: 'flex-start',
              ...
              <div className="styleSousmenu">
                  ...
                  src={LogochannelThumbnail ? element?.channelThumbnail[0]?.url 
                  ...
                  width: '85%'
                    ...
                    <div style={{width: '100%', display: 'flex', justifyContent:'flex-start', alignItems: 'flex-start', flexDirection: 'column', cursor: 'pointer'}}>
                      ...
                      <Link style={{textDecoration: 'none', color: 'black', width: '100%'}}
                        ...
                        <p style={{width: '100%', fontSize: '18px'}}>{element?.channelTitle}</p>
                      </Link>
                      <Link to={`/watch/${element?.videoId}`} 
                            style={{textDecoration: 'none', color: 'black', width: '100%'}}>
                      <div className="ContenuHomedescripVide">
                        {element?.lengthText === "EN DIRECT" ?
                           <p style={{marginRight: '5px'}}>{element?.viewCount} spectateurs</p>
                           :
                           <>
              ...
              <div
                ...
                <div style={{
                        ...
                        <Link to={`/watch/${items?.videoId}`} 
                            ...
                            <div style={{width: "100%", position: 'relative', cursor: 'pointer'}}>
                              <img alt={items?.title} 
                                  ...
                                  width={WidthVideos}
                                  style={{borderRadius: '10px'}}></img>
                              <div className={`${items?.lengthText === "EN DIRECT" ? 'IndicatorLive' : 'IndicatorView'}`}>
                                  <p style={{margin: '0.3em', fontWeight: '600'}}>{items?.lengthText}</p>
                              </div>
                            </div>
                        </Link>
                    <div style={{
                  ...
                  :  <>
                        <Link to={`/watch/${items?.videoId}`} 
                            style={{textDecoration: 'none', color: 'black', width: '100%'}}>
                           <h3 style={{width: '100%', fontSize: '18px'}}>
                        ...
                        style={{textDecoration: 'none', color: 'black', width: '100%'}}>
                            <div className="ContenuHomedescripVide">
                            <p style={{marginRight: '5px'}}>{items?.viewCount} de vues</p>
                            <div style={{display: 'flex', alignSelf: 'center', width: '4px', height: '4px', borderRadius: '50%', backgroundColor: 'black', marginRight: '5px'}}></div>
                        ...
                        return(
                          ...
                          <div style={{
                            ...
                            alignItems: 'flex-start',
                              ...
                              <Link to={`/Channel/${items?.channelId}`} 
                                  style={{textDecoration: 'none', color: 'black', width: '20%'}}>
                              <div className="styleSousmenu">
                                <img style={{ 
                                  width: '50px', 
                                  height: '50px',
                                  ...
                                  cursor: 'pointer',
                                    ...
                                    src={LogochannelThumbnail ? items?.channelThumbnail[0]?.url 
          ...
          {element?.data.map((items, i) => {
            return(
              ...
              <div   
               ...
               <div style={{width: `${WidthVideos}`, 
               marginBottom: '1%', 
               display: 'flex',
               justifyContent: 'center',
               alignItems: 'center',
               }}>
                <img alt={items?.title} width={WidthVideos/2}
                style={{borderRadius: '50%'}}
                height="150px"
                src={`${items?.thumbnail[1]?.url.includes("https:") ? 
                    items?.thumbnail[1]?.url 
                         : 
                "https:" + items?.thumbnail[1]?.url}`}></img>
            </div>
      <h4 style={{marginBottom: '1%'}}>{items?.title}</h4>
      <p style={{marginBottom: '8%'}}>{items?.subscriberCount}</p>
      <button style={{
            border: 'none',
            fontSize: '16px',
            padding: '1vw',
...
return (
  ...
  style={{
    ...
    {element?.data.map((items, i) => (
          ...
          <div onClick={() => MoreContent(index, true)}
                className='HoverV2ColorGray'
                id={`Button-section-${index}`}
        style={{
          width: '100%',
...
if(element?.type === "playlist_listing"){
    return (
        ...
        <div style={{position: 'relative', width: `${WidthVideos}`}}>
        <div id={`Card-Playlist-${index}`}
  ...
  onMouseLeave={() => setSelect(-1)}>
      <div style={{position: 'relative', width: '100%'}}>
          ...
          justifyContent: 'space-between',
              ...
              <MdOutlinePlaylistPlay color='white' fontSize={20} style={{marginLeft: '2%'}}/>
              <p style={{marginRight: '2%', fontWeight: '550'}}>{element?.videoCount} vidéos</p>
          </div>
          {select === element?.title ? <div style={{
              width: '100%',
              height: '98%',
              bottom: '0',
              borderRadius: '5%',
