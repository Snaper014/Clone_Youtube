  ...
  return (
    ...
    <div style={{overflow: 'hidden',
        ...
        <div style={{width: '5%', 
            ...
            { curr === 0 ? <div></div> : <button className='DIRBtn' onClick={prev}>BACK</button>}
            <button className='DIRBtn' onClick={next}>NEXT</button>
        </div>
    </div>
  )
}
        ...
        return(
          <div style={{
            ...
            <div style={{
                ...
                {curr * 100 >= (children.length/value) * 100  ? <div></div>
                  :  <button 
