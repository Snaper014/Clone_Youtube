  ...
  return (
    <>
      <Composantcompose>
        ...
        <Texte>
          <Contenu>
            {NewData.includes("Accueil") ? <ChannelHome data={data} /> : ""}
          </Contenu>
          <Contenu>
            {NewData.includes("Vidéos") ? (
              <AllVideos />
            ) : (
          ...
          <Contenu>
            {NewData.includes("En direct") ? (
              <StreamLive />
            ) : (
              "Cette Chaîne ne contient aucun direct"
            )}
          </Contenu>
          <Contenu>
            {NewData.includes("Playlists") ? (
              <PlaylistChannel />
            ) : (
              "Cette Chaîne ne contient aucunes playlists"
            )}
          </Contenu>
          <Contenu>
            {NewData.includes("Chaînes") ? (
              <Subscriptions />
            ) : (
          ...
          <Contenu>
            {NewData.includes("À propos") ? (
              <Liens />
            ) : (
              "Cette chaîne ne contient pas encore de présentation"
            )}
          </Contenu>
        </Texte>
      </Composantcompose>
