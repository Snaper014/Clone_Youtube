  ...
  return (
    <>
      {responsive ? (
        ...
        >
          <h3 style={{ width: "100%", fontWeight: "400", marginBottom: "2%" }}>
            {" "}
            A propos
          </h3>
          <p style={{ width: "100%", fontSize: "1em", marginBottom: "2%" }}>
          ...
          <p style={{ marginBottom: "2%" }}>{data?.data?.viewCount} vues</p>
        </div>
      ) : (
        <div
          style={{
        ...
        >
          ...
          >
            ...
            >
              <h4 style={{ marginBottom: "2%", fontSize: "22px" }}>
                Description
              </h4>
            ...
            >
              <p style={{ marginBottom: "2%", fontSize: "22px" }}>
                Statistiques
              </p>
              <hr />
              <p style={{ marginBottom: "2%", fontSize: "18px" }}>
