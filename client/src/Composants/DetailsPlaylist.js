    ...
    if (user) {
      GetLibrary(`?limit=${id}`)
        .then((response) => {
          ...
          setRandomNumber(
            Math.floor(
              Math.random() * response?.data?.data?.at(0)?.data?.length,
            ),
          );
        })
      ...
      {responsive <= 1024 ? (
        <ContainerMobile
          styles={{
            position: "relative",
            height: `${
              user ? `${!Playlist?.data?.length ? "90vh" : "auto"}` : "90vh"
            }`,
            ...
            <>
              ...
              >
                ...
                >
                  ...
                  <Link
                    to={`/Playlist/${
                      Playlist?.data?.at(randomNumber)?.idVideo
                    }/${randomNumber}/${id}?type=library`}
                    style={{
                      textDecoration: "none",
              ...
              >
                {!Playlist?.data?.length ? (
                  <p>Aucunes vidéos veuillez en ajoutez.</p>
                ) : (
                      ...
                      >
                        ...
                        >
                          <Alert
                            ...
                            sx={{ width: "100%" }}
                          >
                            Vous avez suprimmé la vidéo avec{" "}
